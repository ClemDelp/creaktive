...
var ClickAlertNews = function(tabhtml){
  ...
  if(cookieAccepted.checked == true){
    ...
    var expireTime = time + 6*(30*(24*60*60*1000)); // 6*30 jours soit 6 mois
