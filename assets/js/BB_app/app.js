...
var global = {
  ...
  init: function () {
    ...
    ///////////////////////////////
    this.models.current_user = new this.Models.User({id:guid(),name:"clem",email : "delpuech.clement@gmail.com",img:"assets/img/default-user-icon-profile.png",color:"#FFF",pw:"clem"});
