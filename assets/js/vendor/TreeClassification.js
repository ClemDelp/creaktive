var TreeClassification ={
...

  {
          ...
          if (a == 0){
            ...
            if ( i >= 1){
              ...
              if ( tableau[i-1][a].vide == true){
                ...
                for ( var l = 0; l < tableau[i-1].length; l++ ){

                  if (tableau[i-1][l].vide == true ){

                    tableau[i][a].top = tableau[i-1][l].top + tableau[i-1][l].height + espaceTopH
    ...
    //Recentre horizontalement les pères ayant un nombre pair de fils au centre de ceux-ci
...

    {
      ...
      var AlignFP= TreeClassification.AlignFatherPair(Position)

      var Final = TreeClassification.MajCenterMatrice(AlignFP)

      TreeClassification.animate(Final)

      var TabFinal = TreeClassification.GetTabFinal(Final)
